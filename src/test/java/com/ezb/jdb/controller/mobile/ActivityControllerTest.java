...
public class ActivityControllerTest extends TestCase {
    ...
    public void queryActivity(){
        ...
        log.info(activityController.queryActivity(pageResult, null));
        log.info(activityController.queryActivity(pageResult, "title30"));
    }

    @Test
    public void viewActivity(){
        log.info(activityController.viewActivity("30"));
    }
    ...
    @Rollback(false)
    public void signup(){
        log.info(activityController.signup("11111114","30"));
        log.info(activityController.signup("11111115","30"));
        log.info(activityController.signup("11111116","30"));
        log.info(activityController.signup("11111117","30"));
        log.info(activityController.signup("11111118", "30"));
    }
    ...
    public void queryMyActivity(){
        ...
        log.info(activityController.queryMyActivity(pageResult, "11111150", ""));
